//
//  GetFeedMessageUseCaseTests.swift
//  PosterrTests
//
...
class GetFeedMessageUseCaseTests: XCTestCase {
    ...
    func testCallUseCase() throws {
        ...
        let useCase: GetFeedMessageUseCaseProtocol = GetFeedMessageUseCase(networking: network)
